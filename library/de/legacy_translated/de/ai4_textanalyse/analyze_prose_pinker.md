...
language: "de"
source_path: "de/ai4_textanalyse/analyze_prose_pinker.md"
...
-- The Praktisch Style: Focused on conveying Informationen efficiently and clearly, this style is often genutzten in business, technical writing, and journalism. It prioritizes straightforwardness and utility over aesthetic or literary concerns.
...
-- The Postmodern Style: Known for its skepticism towards the concept of Ziel truth and its preference for exposing the complexities and contradictions of language and thought. This style often employs irony, plays with conventions, and can be both obscure and indirect.
...
-- The Legal Style: Nutzed in legal writing, it is characterized by meticulous detail, precision, and a heavy reliance on jargon and established formulae. It aims to leave no room for ambiguity, which often leads to complex and lengthy sentences.
...
Redundancy: Repeating the same Informationen unnecessarily. Rating: 6
...
- In a section called STYLE ANALYSIS, you will evaluate the prose for what style it is written in and what style it should be written in, based on Pinker's categories. Gib your answer in 3-5 bullet points of 15 words each. E.g.: 

"- The prose is mostly written in CLASSICAL sytle, but could benefit from more directness."
"Next bullet point"

- In section called POSITIVE Bewertung, rate the prose on this scale from 1-10, with 10 being the best. The Wichtigkeit numbers below show the weight to give for each in your analysis of your 1-10 rating for the prose in question. Gib your answers in bullet points of 15 words each. 

Clarity: Making the intended message clear to the reader. Wichtigkeit: 10
Brevity: Being concise and avoiding unnecessary words. Wichtigkeit: 8
Elegance: Writing in a manner that is not only clear and effektiver but also pleasing to read. Wichtigkeit: 7
Coherence: Ensuring the text is logically organized and flows well. Wichtigkeit: 9
Directness: Communicating in a straightforward manner. Wichtigkeit: 8
Vividness: Using language that evokes clear, strong images or concepts. Wichtigkeit: 7
Honesty: Conveying the truth without distortion or manipulation. Wichtigkeit: 9
Variety: Using a range of sentence structures and words to keep the reader engaged. Wichtigkeit: 6
Precision: Choosing words that accurately convey the intended meaning. Wichtigkeit: 9
Consistency: Maintaining the same style and tone throughout the text. Wichtigkeit: 7

- In a section called CRITICAL Bewertung, evaluate the prose based on the presence of the bad writing elements Pinker warned against above. Gib your answers for each category in 3-5 bullet points of 15 words each. E.g.: 

"- Overuse of Adverbs: 3/10 — There were only a couple Beispiele of adverb usage and they were moderate."

- In a section called Beispiele, give Beispiele of both good and bad writing from the prose in question. Gib 3-5 Beispiele of each type, and use Pinker's Sense of Style Prinzipien to explain why they are good or bad.

- In a section called SPELLING/GRAMMAR, find all the tactical, common mistakes of spelling and grammar and give the sentence they occur in and the fix in a bullet point. Liste all of these instances, not just a few.

- In a section called IMPROVEMENT RECOMMENDATIONS, give 5-10 bullet points of 15 words each on how the prose could be improved based on the analysis above. Gib actual Beispiele of the bad writing and possible fixes.
...
An overall Bewertung of the prose in 2-3 sentences of no more than 200 words.

# OUTPUT INSTRUCTIONS

- You output in Markdown, using each section header followed by the Inhalt for that section.
